...
package_name = "robot_properties_go1"
...
setup(
    ...
    zip_safe=True,
    maintainer="Lhum",
    maintainer_email="elham.daneshmand@mail.mcgill.ca",
    long_description=long_description,
    long_description_content_type="text/markdown",
    # url="https://github.com/Lhumd/robot_properties_go1",
    description="Collection of configuration files for the go1 robots.",
    license="BSD-3-clause",
